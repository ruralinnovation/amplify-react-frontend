var apps = (function (exports) {
    ...
    class DrawLogoTest extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document_1$2.getElementById("svelte-1vb47sl-style")) add_css$2();
...
`;
    ...
    var headerApp1 = !HEADER_REPLACED && headerAppElement1 !== null && (headerAppElement1.constructor.name === "HTMLElement" || headerAppElement1.constructor.name === "HTMLDivElement") ? new CORIHeader({
    ...
    var headerApp2 = !HEADER_REPLACED && headerAppElement2 !== null && (headerAppElement2.constructor.name === "HTMLElement" || headerAppElement2.constructor.name === "HTMLDivElement") ? new RISIHeader({
    ...
    (function () {
      ...
      if (!!checkShinyStatus()) setTimeout(function () {
