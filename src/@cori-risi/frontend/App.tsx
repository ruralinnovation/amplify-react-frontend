            ...
            {(user !== null) ? (
                <div>
                    ...
                    <div id={"auth-control"} className="row show">
                        ...
                        <div className="site-header__item menu-toggle col">
                            <a className="menu-toggle__control js-menu-control js-open-main-menu" role="button" >
                                    <span id="mm-label" className="hamburger-control__label">
                                      <span className="hamburger-control__open-label" aria-hidden="false" style={{ display: "none" }}>
                                        <span className="screen-reader-text">Site Menu</span>
                                      </span>
                                      <span className="hamburger-control__close-label" aria-hidden="true">
                                        <span className="screen-reader-text">Close Menu</span>
                                      </span>
                                    </span>
                                <span className="hamburger-control"
                                      aria-hidden="true">
                                        <span className="hamburger-control__inner"/>
                                        <span className="hamburger-control__inner"/>
                                        <span className="hamburger-control__open" aria-hidden="false" style={{ display: "none" }} >
                                        ...
                                        <span className="hamburger-control__close" aria-hidden="true">
